...
void logToConsole(final LogRecord logRecord,
        {TransformLogRecord? transformer}) =>
...
///
void configLogging(
    {final Level show: Level.INFO,
    final TransformLogRecord transformer = transformerDefault}) {
  hierarchicalLoggingEnabled = true;

  Logger.root.level = show;
  Logger.root.onRecord.listen(
      (final LogRecord event) => logToConsole(event, transformer: transformer));
}
